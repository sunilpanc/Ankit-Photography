          ...
          <h3 class="mt-4"><i class="fas fa-envelope pr-2"></i>Write to us:</h3>
            ...
            <div class="col-md-6">
              <div class="md-form mb-0">
                <input type="text" id="name" class="form-control" name="name" placeholder="Enter Your Name" required="kindly fill the fields">
            ...
            <div class="col-md-6">
              <div class="md-form mb-0">
                <input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" name="email1" id="email" class="form-control" name="email" placeholder="Enter Your Email" required="kindly fill the fields">
            ...
            <div class="col-md-12">
              <div class="md-form mb-0">
                <input type="text" id="subject" class="form-control" name="subject" placeholder="Enter Your Subject" required="kindly fill the fields">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="md-form mb-0">
                  <textarea id="message" class="form-control md-textarea" name="message" rows="3" placeholder="Enter Your Message" required="kindly fill the fields"></textarea>
