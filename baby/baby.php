 ...
 <br><br><br><br>
  ...
  <div class="">
    <div class="row">
        ...
        <img src="pre/2.jpg" alt="" class="img-responsive img-thumbnail col-4 myImg" onclick="big(this)"/>
        <img src="pre/3.jpg" alt="" class="img-responsive img-thumbnail col-4 myImg" onclick="big(this)"/>
        <img src="pre/4.jpg" alt="" class="img-responsive img-thumbnail col-4 myImg" onclick="big(this)"/>
        <img src="pre/5.jpg" alt="" class="img-responsive img-thumbnail col-4 myImg" onclick="big(this)"/>
        <img src="pre/6.jpg" alt="" class="img-responsive img-thumbnail col-4 myImg" onclick="big(this)"/>
        <img src="pre/7.jpg" alt="" class="img-responsive img-thumbnail col-4 myImg" onclick="big(this)"/>
    </div>
  </div>
