...
<body>
 ...
 <br><br><br><br>
  ...
  <div class="">
    <div class="row">
        <img src="pre/1.jpeg" alt=""  class="img-responsive img-thumbnail col-3 myImg" onclick="big(this)"/>
        <img src="pre/2.jpeg" alt="" class="img-responsive img-thumbnail col-3 myImg" onclick="big(this)"/>
        <img src="pre/3.jpeg" alt="" class="img-responsive img-thumbnail col-3 myImg" onclick="big(this)"/>
        <img src="pre/4.jpeg" alt="" class="img-responsive img-thumbnail col-3 myImg" onclick="big(this)"/>
        <img src="pre/5.jpeg" alt="" class="img-responsive img-thumbnail col-3 myImg" onclick="big(this)"/>
        <img src="pre/6.jpeg" alt="" class="img-responsive img-thumbnail col-3 myImg" onclick="big(this)"/>
        <img src="pre/7.jpeg" alt="" class="img-responsive img-thumbnail col-3 myImg" onclick="big(this)"/>
        <img src="pre/8.jpeg" alt="" class="img-responsive img-thumbnail col-3 myImg" onclick="big(this)"/>
        <img src="pre/9.jpeg" alt="" class="img-responsive img-thumbnail col-6 myImg" onclick="big(this)"/>
        <img src="pre/10.jpeg" alt="" class="img-responsive img-thumbnail col-6 myImg" onclick="big(this)"/>
